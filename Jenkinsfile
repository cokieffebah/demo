...
porter_utils.image_wrap {
  ...
  def sh_status = sh(returnStatus: true, script:"DOCKER_CONTENT_TRUST=1 DOCKER_CONTENT_TRUST_SERVER=https://192.168.1.196:4443 docker -D push localhost:5000/intoto-demo:latest") 
