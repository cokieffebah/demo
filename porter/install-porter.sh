...
PORTER_HOME=${1:-~/.porter}
PORTER_URL=https://cdn.porter.sh
PORTER_PERMALINK=${PORTER_PERMALINK:-v0.33.1}
...
echo "Adding porter to your path by adding the following line to your ~/.profile and open a new terminal:"
